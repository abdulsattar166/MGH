...
const navItems: NavItem[] = [
  ...
  { to: "/manage/fees", label: "Fees", icon: "ri-money-rupee-circle-line", roles: ["admin", "superintendent"] },
  { to: "/manage/attendance", label: "Attendance", icon: "ri-calendar-check-line", roles: ["admin", "superintendent"] },
